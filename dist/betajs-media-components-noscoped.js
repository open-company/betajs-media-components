/*!
betajs-media-components - v0.0.117 - 2018-07-30
    ...
    return Class.extend({
            ...
            return {
                ...
                _showBackgroundSnapshot: function() {
                    ...
                    console.log("XXX _showBackgroundSnapshot activeElement:", this.activeElement());
                    console.log("XXX _showBackgroundSnapshot data-video:", el);
                    console.log("XXX _showBackgroundSnapshot dimentions", dimensions);
